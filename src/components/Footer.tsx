...
export default function Footer() {
  return (
    <footer id="contact" className="border-t border-line py-40 px-8 bg-bg overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <FadeIn delay={260}>
          <div className="flex flex-wrap gap-4">
            <a
              ...
              data-cursor="view"
              className="btn-magnetic group flex items-center gap-3 px-6 py-3.5 border text-sm font-semibold overflow-hidden relative"
            ...
            >
              ...
              <span className="ml-1 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">↗</span>
            </a>
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="view"
              className="btn-magnetic group flex items-center gap-3 px-6 py-3.5 border border-line text-ink text-sm font-semibold hover:border-red/30 hover:text-red transition-all duration-500"
            >
              <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mt-28 pt-8 border-t border-line flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <a href="#" className="font-serif gradient-text font-semibold tracking-wide group" style={{ fontSize: '1.2rem' }}>
            Satvik Reddy
          </a>
          <p className="text-[10px] text-dim tracking-widest uppercase font-medium">
